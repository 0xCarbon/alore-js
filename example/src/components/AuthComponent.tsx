...
export default function AuthComponent() {
  ...
  return (
    <Auth
      ...
      title="Bem-vindo!"
      logoContainerClassName="[&>img]:max-w-[75px] [&>img]:mb-3 pl-7 text-left"
      titleClassName="text-xl text-[#333333] font-medium"
      customClassName="border-none shadow-none text-left [&>div]:!py-0 pt-2"
