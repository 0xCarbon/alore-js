...
with_node \
  ...
  --target "/Users/kenny/0xCarbon/alore-js/packages/@alore-sdk/alore-native-crypto-sdk/ios/Pods/Target Support Files/Pods-0xcarbonalorenativeauthsdk/ExpoModulesProvider.swift" \
  --platform "apple" \
