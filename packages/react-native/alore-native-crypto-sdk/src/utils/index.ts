...
type StoreName = 'apiKeyKeyshares' | 'walletKeyshares' | 'accountKeyshares';

type UUID = `${string}-${string}-${string}-${string}-${string}`;

type KeyshareIdentifier =
  | { walletId: UUID; accountId?: never; apiKeyId?: never }
  | { accountId: UUID; walletId?: never; apiKeyId?: never }
  | { apiKeyId: UUID; walletId?: never; accountId?: never };

type KeyshareEntry = { keyshare: Keyshare } & KeyshareIdentifier;
