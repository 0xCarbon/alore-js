export interface Typegen0 {
    ...
    eventsCausingActions: {
        ...
        setSessionUser: 'done.invoke.authMachine.active.login.verifying2faCode:invocation[0]' | 'done.invoke.authMachine.active.login.verifyingCode:invocation[0]' | 'done.invoke.authMachine.active.login.verifyingEmail2fa:invocation[0]' | 'done.invoke.authMachine.active.login.verifyingGoogleLogin:invocation[0]' | 'done.invoke.authMachine.active.login.verifyingHwAuth:invocation[0]' | 'done.invoke.authMachine.active.register.completingRegistration:invocation[0]';
    ...
    eventsCausingGuards: {
        ...
        isNewDevice: 'done.invoke.authMachine.active.login.verifying2faCode:invocation[0]' | 'done.invoke.authMachine.active.login.verifyingHwAuth:invocation[0]' | 'done.invoke.authMachine.active.login.verifyingLogin:invocation[0]';
    ...
    matchesStates: 'active' | 'active.forgotPassword' | 'active.forgotPassword.codeSent' | 'active.forgotPassword.idle' | 'active.forgotPassword.newPassword' | 'active.forgotPassword.passwordSaved' | 'active.forgotPassword.savingPassword' | 'active.forgotPassword.sendingCode' | 'active.login' | 'active.login.email2fa' | 'active.login.fetchingForgeData' | 'active.login.googleLogin' | 'active.login.hardware2fa' | 'active.login.idle' | 'active.login.inputPassword' | 'active.login.newDevice' | 'active.login.resendingConfirmationEmail' | 'active.login.resendingEmailCode' | 'active.login.retrievingSalt' | 'active.login.software2fa' | 'active.login.successfulLogin' | 'active.login.verifying2faCode' | 'active.login.verifyingCode' | 'active.login.verifyingEmail2fa' | 'active.login.verifyingGoogleLogin' | 'active.login.verifyingHwAuth' | 'active.login.verifyingLogin' | 'active.register' | 'active.register.completingRegistration' | 'active.register.createPassword' | 'active.register.emailValidation' | 'active.register.googleLogin' | 'active.register.idle' | 'active.register.resendingRegistrationEmail' | 'active.register.sendingEmail' | 'active.register.termsModal' | 'active.register.userCreated' | 'active.register.verifyingEmail' | 'active.web3Connector' | 'active.web3Connector.connecting' | 'active.web3Connector.email2faCode' | 'active.web3Connector.emailConfirmed' | 'active.web3Connector.emailInput' | 'active.web3Connector.idle' | 'active.web3Connector.verifyingClaimNftEmail2fa' | 'active.web3Connector.verifyingEmailEligibility' | 'inactive' | {
        active?: 'forgotPassword' | 'login' | 'register' | 'web3Connector' | {
            ...
            login?: 'email2fa' | 'fetchingForgeData' | 'googleLogin' | 'hardware2fa' | 'idle' | 'inputPassword' | 'newDevice' | 'resendingConfirmationEmail' | 'resendingEmailCode' | 'retrievingSalt' | 'software2fa' | 'successfulLogin' | 'verifying2faCode' | 'verifyingCode' | 'verifyingEmail2fa' | 'verifyingGoogleLogin' | 'verifyingHwAuth' | 'verifyingLogin';
            register?: 'completingRegistration' | 'createPassword' | 'emailValidation' | 'googleLogin' | 'idle' | 'resendingRegistrationEmail' | 'sendingEmail' | 'termsModal' | 'userCreated' | 'verifyingEmail';
